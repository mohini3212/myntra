    ...
    return (
        <section >
            <div className="container1">
                <h6 className="heading">Home/Clothing/Men Clothing/ <span>New Collection Men Wear</span></h6>
                <div className="grid-three-cols">

                    <div className="overview">
                        <div className="grid-two-cols">
                            <img src="images/lower1.jpg" alt="overview1" />
                            <img src="images/lower3.jpg" alt="overview2" />
                            <img src="images/lower6.jpg" alt="overview3" />
                            <img src="images/lower7.jpg" alt="overview4" />
                            <img src="images/lower8.jpg" alt="overview4" />
                        </div>
                    </div>

                    <div className="product-content">
                        <h5>Lower</h5>
                        <p>Comfortable Lower</p>
                        ...
                        <div className="color" >
                            ...
                            <div className="more-color">
                                <img src="images/lower2.jpg" alt="lower1" />
                                <img src="images/lower4.jpg" alt="lower2" />
                            </div>
                            <h6>SELECT SIZE</h6>
                        ...
                        <div className="delivery-info">
                            ...
                            <div className="customer-info">
                                ...
                                <div className="more-color">
                                    <img src="images/lower1.jpg" alt="lower1" />
                                    <img src="images/lower7.jpg" alt="lower2" />
                                    <img src="images/lower8.jpg" alt="lower3" />
                                </div>
                            ...
                            <div className="customer-info p-4 ps-0 pe-0">
                                ...
                                <div className="more-color ms-4 ps-4 ">
                                       <img src="images/lower8.jpg" className="ms-4" alt="lower3" />
